...
## Objective 
- Use the classification algorithms to create a model based on training data and evaluate testing data using evaluation metrics.
- Build the models using the following algorithms:
1. Linear Regression
2. KNN
3. Decision Trees
...
7.  R2-Score
- Use your models to generate the report. 
